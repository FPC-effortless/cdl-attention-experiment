"""Run PNDS-GATE-001 Stage 2b held-out routing comparison and emit JSON."""
from __future__ import annotations
import argparse
import json
from pathlib import Path

from .stage2b_heldout import run
...
def main() -> None:
    ...
    p.add_argument("--output", type=Path, default=Path("pnds_gate_001_stage2b.json"))
    a = p.parse_args()
...
def _multiseed(a) -> dict:
    ...
    import math
    from .stage2b_heldout import run as _run
